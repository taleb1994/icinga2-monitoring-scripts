#!/bin/bash
echo "--- Running Icinga Agent Setup for worker1.external.tpf-i-ost-test.e21x.de ---"
...
icinga2 node setup \
--ticket 2de9dcb2a4e97d32f9f7018fa083692a0b8dee10 \
--listen 0.0.0.0,5665 \
--cn worker1.external.tpf-i-ost-test.e21x.de \
--zone worker1.external.tpf-i-ost-test.e21x.de \
