#!/bin/bash
echo "--- Running Icinga Agent Setup for worker4.external.tpf-i-now-test.e21x.de ---"
...
icinga2 node setup \
--ticket 550664c49362421d0724cd8297892c3bb53a0fd3 \
--listen 0.0.0.0,5665 \
--cn worker4.external.tpf-i-now-test.e21x.de \
--zone worker4.external.tpf-i-now-test.e21x.de \
