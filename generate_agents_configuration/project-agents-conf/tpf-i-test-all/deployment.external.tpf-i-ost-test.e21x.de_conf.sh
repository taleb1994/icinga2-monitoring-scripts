#!/bin/bash
echo "--- Running Icinga Agent Setup for deployment.external.tpf-i-ost-test.e21x.de ---"
...
icinga2 node setup \
--ticket a29239bd74b4fb1b89eed8025c8b45c60970955b \
--listen 0.0.0.0,5665 \
--cn deployment.external.tpf-i-ost-test.e21x.de \
--zone deployment.external.tpf-i-ost-test.e21x.de \
