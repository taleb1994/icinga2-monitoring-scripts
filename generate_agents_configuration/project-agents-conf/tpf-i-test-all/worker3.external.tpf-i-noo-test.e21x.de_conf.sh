#!/bin/bash
echo "--- Running Icinga Agent Setup for worker3.external.tpf-i-noo-test.e21x.de ---"
...
icinga2 node setup \
--ticket c7d47cdb3cc7da326f290f2617f9560ed76b2965 \
--listen 0.0.0.0,5665 \
--cn worker3.external.tpf-i-noo-test.e21x.de \
--zone worker3.external.tpf-i-noo-test.e21x.de \
