#!/bin/bash
echo "--- Running Icinga Agent Setup for kafka1.external.tpf-i-noo-test.e21x.de ---"
...
icinga2 node setup \
--ticket c32a26e338a8d768a5e56375b61d6a8d41444ae6 \
--listen 0.0.0.0,5665 \
--cn kafka1.external.tpf-i-noo-test.e21x.de \
--zone kafka1.external.tpf-i-noo-test.e21x.de \
