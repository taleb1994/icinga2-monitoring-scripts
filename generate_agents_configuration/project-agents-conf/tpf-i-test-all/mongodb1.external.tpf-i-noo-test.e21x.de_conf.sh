#!/bin/bash
echo "--- Running Icinga Agent Setup for mongodb1.external.tpf-i-noo-test.e21x.de ---"
...
icinga2 node setup \
--ticket bf5a284a06759ba86f57784c04039c6f1e96d85e \
--listen 0.0.0.0,5665 \
--cn mongodb1.external.tpf-i-noo-test.e21x.de \
--zone mongodb1.external.tpf-i-noo-test.e21x.de \
