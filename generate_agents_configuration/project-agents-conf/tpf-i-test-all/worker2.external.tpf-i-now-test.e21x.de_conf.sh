#!/bin/bash
echo "--- Running Icinga Agent Setup for worker2.external.tpf-i-now-test.e21x.de ---"
...
icinga2 node setup \
--ticket 53d528a44101f5767fba369a99ad10a6a1b5e1aa \
--listen 0.0.0.0,5665 \
--cn worker2.external.tpf-i-now-test.e21x.de \
--zone worker2.external.tpf-i-now-test.e21x.de \
