#!/bin/bash
echo "--- Running Icinga Agent Setup for worker1.external.tpf-i-noo-test.e21x.de ---"
...
icinga2 node setup \
--ticket 52b20f60a1c06d48f51dcbe96ee7edf1006d0482 \
--listen 0.0.0.0,5665 \
--cn worker1.external.tpf-i-noo-test.e21x.de \
--zone worker1.external.tpf-i-noo-test.e21x.de \
