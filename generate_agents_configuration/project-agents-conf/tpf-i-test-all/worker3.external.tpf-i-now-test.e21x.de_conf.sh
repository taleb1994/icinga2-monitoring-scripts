#!/bin/bash
echo "--- Running Icinga Agent Setup for worker3.external.tpf-i-now-test.e21x.de ---"
...
icinga2 node setup \
--ticket 79a03c15261b75ea456d80ad2dcef6db04deb365 \
--listen 0.0.0.0,5665 \
--cn worker3.external.tpf-i-now-test.e21x.de \
--zone worker3.external.tpf-i-now-test.e21x.de \
