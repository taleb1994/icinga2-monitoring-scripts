#!/bin/bash
echo "--- Running Icinga Agent Setup for deployment.external.tpf-i-now-test.e21x.de ---"
...
icinga2 node setup \
--ticket 0a2a1856eafe52ca45e6d9b377b6f9a57f267982 \
--listen 0.0.0.0,5665 \
--cn deployment.external.tpf-i-now-test.e21x.de \
--zone deployment.external.tpf-i-now-test.e21x.de \
