#!/bin/bash
echo "--- Running Icinga Agent Setup for worker4.external.tpf-i-noo-test.e21x.de ---"
...
icinga2 node setup \
--ticket 22638f31267d9402f0dab63feeb0f126f9b73e90 \
--listen 0.0.0.0,5665 \
--cn worker4.external.tpf-i-noo-test.e21x.de \
--zone worker4.external.tpf-i-noo-test.e21x.de \
