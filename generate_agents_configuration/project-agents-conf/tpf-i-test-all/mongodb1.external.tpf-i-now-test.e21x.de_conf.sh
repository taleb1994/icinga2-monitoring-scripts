#!/bin/bash
echo "--- Running Icinga Agent Setup for mongodb1.external.tpf-i-now-test.e21x.de ---"
...
icinga2 node setup \
--ticket cab6f1722a5b57f8a76b8104ba3539866dd862e4 \
--listen 0.0.0.0,5665 \
--cn mongodb1.external.tpf-i-now-test.e21x.de \
--zone mongodb1.external.tpf-i-now-test.e21x.de \
