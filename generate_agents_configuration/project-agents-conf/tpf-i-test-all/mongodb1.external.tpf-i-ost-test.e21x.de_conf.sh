#!/bin/bash
echo "--- Running Icinga Agent Setup for mongodb1.external.tpf-i-ost-test.e21x.de ---"
...
icinga2 node setup \
--ticket c7956da3189e2768ec7c8ba6f07621241c4755f3 \
--listen 0.0.0.0,5665 \
--cn mongodb1.external.tpf-i-ost-test.e21x.de \
--zone mongodb1.external.tpf-i-ost-test.e21x.de \
