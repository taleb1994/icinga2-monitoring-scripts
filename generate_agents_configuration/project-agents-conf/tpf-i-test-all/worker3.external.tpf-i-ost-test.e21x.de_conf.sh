#!/bin/bash
echo "--- Running Icinga Agent Setup for worker3.external.tpf-i-ost-test.e21x.de ---"
...
icinga2 node setup \
--ticket 2c7a30ef5b2416fb54f70d2b05dee675deeffed4 \
--listen 0.0.0.0,5665 \
--cn worker3.external.tpf-i-ost-test.e21x.de \
--zone worker3.external.tpf-i-ost-test.e21x.de \
