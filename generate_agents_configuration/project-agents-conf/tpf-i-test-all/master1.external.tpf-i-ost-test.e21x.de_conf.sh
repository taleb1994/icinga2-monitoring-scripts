#!/bin/bash
echo "--- Running Icinga Agent Setup for master1.external.tpf-i-ost-test.e21x.de ---"
...
icinga2 node setup \
--ticket 9ed27b832037e5c325d3299f4445a3fa81dc262a \
--listen 0.0.0.0,5665 \
--cn master1.external.tpf-i-ost-test.e21x.de \
--zone master1.external.tpf-i-ost-test.e21x.de \
