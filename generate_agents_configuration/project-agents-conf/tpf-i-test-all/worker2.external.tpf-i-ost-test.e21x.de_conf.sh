#!/bin/bash
echo "--- Running Icinga Agent Setup for worker2.external.tpf-i-ost-test.e21x.de ---"
...
icinga2 node setup \
--ticket 7cd8dfea8a5f19526cac671b9cd6b398a266f707 \
--listen 0.0.0.0,5665 \
--cn worker2.external.tpf-i-ost-test.e21x.de \
--zone worker2.external.tpf-i-ost-test.e21x.de \
