#!/bin/bash
echo "--- Running Icinga Agent Setup for master1.external.tpf-i-now-test.e21x.de ---"
...
icinga2 node setup \
--ticket 9f067cbe1d470cedfe82967438a0224c40916540 \
--listen 0.0.0.0,5665 \
--cn master1.external.tpf-i-now-test.e21x.de \
--zone master1.external.tpf-i-now-test.e21x.de \
