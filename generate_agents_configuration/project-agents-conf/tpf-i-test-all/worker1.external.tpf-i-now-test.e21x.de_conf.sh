#!/bin/bash
echo "--- Running Icinga Agent Setup for worker1.external.tpf-i-now-test.e21x.de ---"
...
icinga2 node setup \
--ticket 0dc9fb7bebcded838ebcba94e2842345cf152335 \
--listen 0.0.0.0,5665 \
--cn worker1.external.tpf-i-now-test.e21x.de \
--zone worker1.external.tpf-i-now-test.e21x.de \
