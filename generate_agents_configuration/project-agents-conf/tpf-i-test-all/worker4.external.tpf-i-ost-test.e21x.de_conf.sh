#!/bin/bash
echo "--- Running Icinga Agent Setup for worker4.external.tpf-i-ost-test.e21x.de ---"
...
icinga2 node setup \
--ticket 08a2d1ba92740e7e617064a68ded2fabb574ddc5 \
--listen 0.0.0.0,5665 \
--cn worker4.external.tpf-i-ost-test.e21x.de \
--zone worker4.external.tpf-i-ost-test.e21x.de \
